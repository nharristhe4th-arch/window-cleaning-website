...
export function Services() {
  return <section id="services" className="sg-section"><div className="sg-wrap">
    ...
    <p>From single homes and storefronts to full property portfolios, we tailor every service to how your property is used. We also offer pressure washing and soft washing.</p>
